...
#book-meta(
  ...
  summary: [
    ...
    - #chapter("content/DIP/chapters/4频率域图像增强.typ", section: "4")[频率域图像增强]
    - #chapter("content/DIP/chapters/5图像复原.typ", section: "5")[图像复原]
    - #chapter("content/DIP/chapters/6多分辨率处理.typ", section: "6")[多分辨率处理]
    - #chapter("content/DIP/chapters/7图像压缩.typ", section: "7")[图像压缩]
    - #chapter("content/DIP/chapters/8形态学处理.typ", section: "8")[形态学处理]
    ...
    - #chapter("content/DSA/chapters/4串.typ", section: "4")[串]
    - #chapter("content/DSA/chapters/5数组和广义表.typ", section: "5")[数组和广义表]
    - #chapter("content/DSA/chapters/6树和二叉树.typ", section: "6")[树和二叉树]
    - #chapter("content/DSA/chapters/7图.typ", section: "7")[图]
    - #chapter("content/DSA/chapters/8查找.typ", section: "8")[查找]
    - #chapter("content/DSA/chapters/9排序.typ", section: "9")[排序]
    - #chapter("content/DSA/chapters/10Exercise.typ", section: "10")[Exercise]
  ],
)
